...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.search_frame.grid(row=3, column=2, padx=8, pady=(0, 8), sticky="nswe", rowspan=1)
        
        self.settings_frame = SettingsFrame(self, self.result_frame)
        self.settings_frame.grid(row=2, column=0, padx=(8, 0), pady=(0, 8), sticky="nswe", rowspan=2)
